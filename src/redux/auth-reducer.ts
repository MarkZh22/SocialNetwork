...
const authReducer = (state = initialState, action: checkUserIsAuthType|  getCaptchaUrlSuccessType | setIsCaptchaType | setUserDataType | errorDataType):initialStateType => {
    switch (action.type) {
        case SET_USER_DATA: {
