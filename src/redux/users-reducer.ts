...
export const getUsersThunkCreate = (currentPage: number|null, pageSize: number|null) => {
...
export const onClickPageThunkCreate = (p: number|null, pageSize: number|null) => {
    return async (dispatch: any) => {
...
export const followThunk = (userId: number|null) => {
    return async (dispatch: any) => {
...
export const unFollowThunk = (userId: number|null) => {
    return async (dispatch: any) => {
        dispatch(toggleFollowing(true,userId))
